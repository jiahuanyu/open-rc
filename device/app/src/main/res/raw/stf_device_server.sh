...
CLASSPATH=/data/app/me.jiahuan.stf.server-QwmZTqvUmiW_mAdHQbeQqQ==/base.apk app_process /system/bin --nice-name=stf_device_server me.jiahuan.stf.server.Server
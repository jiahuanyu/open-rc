...
import me.jiahuan.openrc.device.server.device.DeviceInfo
import me.jiahuan.openrc.device.server.encoder.ScreenEncoder
import me.jiahuan.openrc.device.server.device.manager.ServiceManager
import me.jiahuan.openrc.device.server.connection.model.WebSocketMessage
import me.jiahuan.openrc.device.server.connection.model.input.InputEventData
 ...
 * WebSocket 服务端
 */
class WebSocketClientConnection(device: Device) : Connection(device),
    AppWebSocketClient.ClientEventsHandler {

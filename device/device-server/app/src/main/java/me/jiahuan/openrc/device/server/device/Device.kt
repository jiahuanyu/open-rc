...
import me.jiahuan.openrc.device.server.device.manager.InputManager
...
class Device {
    ...
    private val supportInputEvents = displayId == 0 || Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q
